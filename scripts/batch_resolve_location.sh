...
DATA_FOLDER="/export/b10/jzhan237/carmen-update/data/twitter-public-random/public_random_samples_flatten"
INPUT_FILES=($DATA_FOLDER/*.gz)
PUBLIC_RANDOM_OUT="/home/jzhan237/export/carmen-update/evaluation/exp_public_random_locations_${LOC_FILE_STR}"

OUTPUT_DIR=$PUBLIC_RANDOM_OUT
mkdir -p $OUTPUT_DIR
...
then
    ...
    time python batch_resolve_location.py \
...
##### optional aggregation
    time python batch_resolve_location.py --output-path $OUTPUT_DIR --aggregate
#####
