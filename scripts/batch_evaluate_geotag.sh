...
#$ -N bch-strm-partial  # Name of the job
...
# STM_GEOTAG_OUTPUT="/home/jzhan237/export/carmen-update/evaluation/exp_stream_${LOC_FILE_STR}/"

# filter by en or us
FILTER_NAME="us"
IO="inside"
DATA_FOLDER="/home/jzhan237/export/carmen-update/data/twitter-geo-stream-${FILTER_NAME}-split/${IO}_tweets"
INPUT_FILES=($DATA_FOLDER/*.gz)
STM_GEOTAG_OUTPUT="/home/jzhan237/export/carmen-update/evaluation/new_exp_stream_partial/${FILTER_NAME}_${IO}_${LOC_FILE_STR}/"
