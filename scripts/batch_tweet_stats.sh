...
PUBLIC_RANDOM_OUT="/home/jzhan237/export/carmen-update/evaluation/exp_public_random_stats"
...
then
    ...
    time python batch_tweet_stats.py \
...
##### optional aggregation
    time python batch_tweet_stats.py --output-path $OUTPUT_DIR --aggregate
#####
