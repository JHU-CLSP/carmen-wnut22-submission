...
# input
DATA_FOLDER="/home/jzhan237/export/carmen-update/data/twitter-world/world-test-splits"
INPUT_FILES=($DATA_FOLDER/*.json)
WORLD_OUTPUT="/home/jzhan237/export/carmen-update/evaluation/new_exp_world_${LOC_FILE_STR}/"
